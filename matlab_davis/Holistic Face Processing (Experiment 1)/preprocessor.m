...
[trainDataHalf,testDataHalf,validDataHalf] = createHalfFaceSet(trainData,testData,validData);

trainLabels = [trainLabels, trainLabels];
testLabels = [testLabels, testLabels];
validLabels = [validLabels, validLabels];


[trainPCA, testPCA, validPCA] = PCA(trainDataHalf, testDataHalf, validDataHalf, 'extracting PCA for all sets');
